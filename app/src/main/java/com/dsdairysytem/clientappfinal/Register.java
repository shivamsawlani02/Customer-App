...
public class Register extends AppCompatActivity {
    ...
    TextView text1;
    EditText name,email,houseNo,colony,city,postalCode;
    Button btn_nxt;
    String newToken;
        ...
        btn_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Name.isEmpty()) {
                    ...
                    email.setError("Enter House Number");
                }
...
//                        } else {
                    ...
                    profileDoc.put("Postal Code",PostalCode);
                            documentReference.set(profileDoc);
                            Intent intent = new Intent(Register.this,Geolocation.class);
